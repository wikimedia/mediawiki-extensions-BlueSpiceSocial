...
class EntityFormatter {
	...
	public function format() {
		...
		$this->result['ctime'] = \RequestContext::getMain()->getLanguage()->date( $this->entity->getTimestampCreated() );
		$this->result['mtime'] = \RequestContext::getMain()->getLanguage()->date( $this->entity->getTimestampTouched() );
		...
		$this->result['owner'] = $this->linkRenderer->makeLink( $owner->getUserpage(), $name );
	}
}
